...
describe('PaymentsView', () => {
  ...
  it('toggles sort direction on same header and respects pagination bounds', async () => {
    const user = userEvent.setup();
    const students = [
      buildStudent({ id: 1, firstName: 'Zed', mode: 'Online', school: 'School B', subjects: ['Biology'] }),
      buildStudent({ id: 2, firstName: 'Amy', mode: 'Face to Face', school: 'School A', subjects: ['Chemistry'] }),
      buildStudent({ id: 3, firstName: 'Noah', mode: 'Online', school: 'School C', subjects: ['Mathematics'] }),
      buildStudent({ id: 4, firstName: 'Ben', mode: 'Face to Face', school: 'School D', subjects: ['Physics'] }),
      buildStudent({ id: 5, firstName: 'Kai', mode: 'Online', school: 'School E', subjects: ['English'] }),
      buildStudent({ id: 6, firstName: 'Mia', mode: 'Face to Face', school: 'School F', subjects: ['History'] }),
    ];
