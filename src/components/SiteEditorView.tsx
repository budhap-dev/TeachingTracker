 ...
 * form, rows drag-to-reorder, and one Publish that goes live with no deploy.
 *
 * No preview tab any more (2026-08-14): it rendered the Offerings page
 * alone, which had stopped being where most of this form's words land.
 * Publishing is atomic and reversible — the site is its own preview.
 */
...
type Draft = {
    ...
    /** The Home page's own wording (2026-08-14) — edited whole. */
...
const assemble = (draft: Draft): SiteContent => ({
    ...
    home: {
        metaTitle: draft.home.metaTitle.trim(),
        metaDescription: draft.home.metaDescription.trim(),
        ctaLabel: draft.home.ctaLabel.trim(),
        exploreLabel: draft.home.exploreLabel.trim(),
        highlightsHeading: draft.home.highlightsHeading.trim(),
        journeyHeading: draft.home.journeyHeading.trim(),
    },
...
export const SiteEditorView = ({
    ...
    return (
        <section className="content-stack">
                ...
                <div className="section-header">
                    <div>
                        ...
                        <p className="section-subtitle">
                            Edit what visitors read on the public pages and
                            publish — live at once, no deploy.
                        </p>
                    </div>
            ...
            {/* No Preview tab (2026-08-14): it rendered Offerings alone,
                which shows barely a third of what this form edits — the
                Home wording, the pinned note, the tab bars and the masthead
                pill were all invisible in it, under a note promising the
                page "exactly as a visitor will see it". Publishing is live
                and reversible; the site itself is the honest preview. */}
            {/* No "Page sections" control (2026-08-14): of the
                seven keys, only 'hero' and 'approach' still draw
                anything on Offerings — the rest moved to Home,
                About and the FAQ page — so ordering them was a
                drag handle over nothing. `sectionOrder` itself
                stays in the document: the API validates it as a
                full permutation, and it still decides where the
                hero sits relative to the approach card. */}
            <details className="card editor-accordion">
                <summary className="editor-accordion-summary">
            ...
            {/* The Home page's own words (2026-08-14): the headings
                and buttons that used to be fixed in the code. Every
                field here may be left blank — the page falls back to
                its usual wording, so clearing one is safe. */}
            <details className="card editor-accordion">
                <summary className="editor-accordion-summary">
                    <h4 className="offerings-heading">Home page wording</h4>
                    <ExpandMoreRoundedIcon className="editor-accordion-chevron" fontSize="small" />
                </summary>

                <p className="section-subtitle">
                    Leave any of these blank to keep the usual
                    wording.
                </p>
                <div className="site-editor-fields">
                    <TextField
                        ...
                        helperText="The big button in the hero band, normally “Request a free assessment”."
                    />
                    <TextField
                        label="Second link"
                        size="small"
                        value={draft.home.exploreLabel}
                        onChange={(event) =>
                            edit((next) => {
                                next.home.exploreLabel =
                                    event.target.value
                            })
                        }
                        helperText="The quieter link beside it, normally “Explore subjects”. It always opens the Offerings page; the arrow is added for you."
                    />
                    <TextField
                        label="Selling-points heading"
                        size="small"
                        value={draft.home.highlightsHeading}
                        onChange={(event) =>
                            edit((next) => {
                                next.home.highlightsHeading =
                                    event.target.value
                            })
                        }
                        helperText="Above the tiles, normally “Why AbhiTutor”."
                    />
                    <TextField
                        label="How-it-works heading"
                        size="small"
                        value={draft.home.journeyHeading}
                        onChange={(event) =>
                            edit((next) => {
                                next.home.journeyHeading =
                                    event.target.value
                            })
                        }
                        helperText="Above the numbered steps, normally “How it works”."
                    />
                    <TextField
                        label="Search-result title"
                        size="small"
                        value={draft.home.metaTitle}
                        onChange={(event) =>
                            edit((next) => {
                                next.home.metaTitle =
                                    event.target.value
                        ...
                        helperText="The browser tab name and the blue line in Google results. Around 60 characters."
                    />
                    <TextField
                        label="Search-result description"
                        size="small"
                        multiline
                        value={draft.home.metaDescription}
                        onChange={(event) =>
                            edit((next) => {
                                next.home.metaDescription =
                                    event.target.value
                            })
                        }
                        helperText="The grey summary under it in Google results. Around 160 characters — it is not shown on the page itself."
                    />
                </div>
            </details>
